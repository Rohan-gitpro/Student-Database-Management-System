...
public class failedStudentsController {
	...
	@FXML
	private Button failedStudentsButton;

	@FXML
	void initialize() {
		

		failedStudentsButton.setOnAction(event -> {
			failStudents();
		...
		private void failedStudents() {
			...
			String sql = "select * from stumarks where cgpa < 4";
			try{
